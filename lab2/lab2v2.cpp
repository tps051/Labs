...
int* (*action(int*, int))(int* array, int len);//возвращает указатель на функцию в соответствии с резльтатом сравнени€ первого элемента и суммы элементов массива (без него)
